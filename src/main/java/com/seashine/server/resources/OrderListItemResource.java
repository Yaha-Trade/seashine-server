...
public class OrderListItemResource {
	...
	public ResponseEntity<Page<OrderListItemListDTO>> getAllOrderListItemsApproved(
		...
		Page<OrderListItem> orderListItems = (Page<OrderListItem>) orderListItemService.getAllOrderListItemsApproved(
				page, linesPerPage, orderBy, orderByDirection.toUpperCase(), customer, season, order, factory,
	...
	@RequestMapping(value = "allproductsapproved/page", method = RequestMethod.GET)
	public ResponseEntity<Page<OrderListItemListDTO>> getAllProductsApproved(
			@RequestParam(value = "page", defaultValue = "0") Integer page,
			@RequestParam(value = "rowsPerPage", defaultValue = "50") Integer linesPerPage,
			@RequestParam(value = "orderBy", defaultValue = "quantity") String orderBy,
			@RequestParam(value = "orderByDirection", defaultValue = "ASC") String orderByDirection,
		...
		Page<OrderListItem> orderListItems = (Page<OrderListItem>) orderListItemService.getAllProductsApproved(page,
				linesPerPage, orderBy, orderByDirection.toUpperCase(), customer, season, order, factory,
				productReference, productDescription);
